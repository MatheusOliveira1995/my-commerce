...
const ProductDetailSkeleton = (): ReactElement => {
  return (
    <Box sx={DETAIL_SKELETON_SX.root}>
      <Box sx={DETAIL_SKELETON_SX.imageContainer}>
        <Skeleton
          variant="rounded"
          animation="wave"
          sx={{
            ...DETAIL_SKELETON_SX.imageFrame,
            borderRadius: 2,
          }}
        />
      </Box>
      ...
      <Card>
        <CardContent sx={DETAIL_SKELETON_SX.cardContent}>
          <Stack sx={DETAIL_SKELETON_SX.contentStack}>
